export class Utils {
  ...
  static nextListItem(item: string, list: string[]): string | null {
  ...
  static encodeBase64(src: string, failRet: string): string {
    let ret;
  ...
  static decodeBase64(src: string, failRet: string): string {
    let ret;
